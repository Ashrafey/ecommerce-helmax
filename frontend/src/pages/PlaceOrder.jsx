        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3  flex-col lg:flex-row'>
            ...
            <div
              ...
              className="flex items-center gap-3 border p-2 px-3 cursor-pointer min-w-[150px] max-w-full flex-1"
            >
              <p className={`min-w-[14px] h-[14px] border rounded-full ${method === 'stripe' ? "bg-green-400" : ''}`}></p>
              <img className="h-5 mx-4 max-w-[80px] object-contain" src={assets.stripe_logo} alt="stripe" />
            </div>
            ...
            >
              ...
              <img className="h-5 mx-4 max-w-[80px] object-contain" src={assets.razorpay_logo} alt="razorpay" />
            </div>
